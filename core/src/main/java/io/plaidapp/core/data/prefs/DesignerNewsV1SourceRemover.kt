...
/**
 * Checks if [key] is a DesignerNews v1 API data source and if so, removes it from [prefs].
 * @return `true` if [key] is a DesignerNews v1 data source & was removed, otherwise `false`.
 */
